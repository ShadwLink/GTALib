...
public class VertexDeclaration {
    ...
    /*private static VertexElementType GetType(long typeDecl, int index) {
    ...
    private void DecodeSingleElement(ICollection<VertexElement> list, int index, int streamIndex, VertexElementUsage usage, ref int usageIndex) {
        int declTypes = DeclarationTypes;
        int usageFlags = UsageFlags;
        int usageFlagMask = (uint)(1 << index);
        int type = GetType(declTypes, index);
