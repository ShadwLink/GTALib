...
public class IPL_IV {
	...
	public void readHeader(ReadFunctions rf) {
		...
		/*
		 * System.out.println(unused1); System.out.println(grge);
		 * System.out.println(cars); System.out.println(cull);
		 * System.out.println(unused2); System.out.println(unused3);
		 * System.out.println(unused4); System.out.println(strbig);
		 * System.out.println(lcul); System.out.println(zone);
		 * System.out.println(unused5); System.out.println(unused6);
		 * System.out.println(unused7); System.out.println(unused8);
