...
public class Item_INST extends IPL_Item {
	...
	public void read(String line) {
		...
		case Constants.gSA:
			...
			rotation = new Vector4D(Float.valueOf(split[6]), Float.valueOf(split[7]), Float.valueOf(split[8]),
					Float.valueOf(split[9]));
		...
		case Constants.gVC:
			...
			rotation = new Vector4D(Float.valueOf(split[9]), Float.valueOf(split[10]), Float.valueOf(split[11]),
					Float.valueOf(split[12]));
			break;
		case Constants.gIII:
			id = Integer.valueOf(split[0]);
			name = split[1];
			...
			rotation = new Vector4D(Float.valueOf(split[8]), Float.valueOf(split[9]), Float.valueOf(split[10]),
					Float.valueOf(split[11]));
			break;
		}
