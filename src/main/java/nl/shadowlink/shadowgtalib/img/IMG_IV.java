...
public class IMG_IV {
	...
	public void readUnEncryptedImg(ReadFunctions rf, IMG image) {
		...
		System.out.println("Size of table items: " + Utils.getHexString(rf.readShort()));
		...
		for (int curItem = 0; curItem < itemCount; curItem++) {
			...
			System.out.println("-------------------------------");
			System.out.println("Offset: " + Utils.getHexString(itemOffset));
			System.out.println("Size: " + itemSize + " bytes");
			System.out.println("Type: " + Utils.getHexString(itemType) + " " + itemType);
	...
	public void readEncryptedImg(ReadFunctions test, IMG img) {
		...
		for (int i = 0; i < itemCount; i++) {
			...
			System.out.println("Offset: " + Utils.getHexString(itemOffset));
			System.out.println("Size: " + itemSize + " bytes");
			System.out.println("Type: " + Utils.getHexString(itemType));
			System.out.println("UsedBlocks: " + usedBlocks);
			System.out.println("Padding: " + Padding);
			item.setOffset(itemOffset);
			item.setSize(usedBlocks * 0x800 - Padding);
