...
public class ShaderGroup {
    ...
    public void Read(ByteReader br){
        ...
        if(TextureDictionaryOffset != -1){
            //Message.displayMsgHigh("There is a wtd: " + Util.getHexString(TextureDictionaryOffset));
    ...
    public String[] getDataValues(){
        ...
        values[0] = "" + VTable;
        values[1] = Util.getHexString(TextureDictionaryOffset);
